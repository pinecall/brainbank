...
## MCP Tool
**`brainbank_context`** — Semantic search. Pass `task` to find relevant code by meaning. Returns chunks with BrainBankQL enrichments (call tree, symbols, imports, line numbers).
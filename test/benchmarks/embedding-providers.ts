...
import { BrainBank, OpenAIEmbedding, PerplexityEmbedding, PerplexityContextEmbedding } from '../../src/index.ts';
import type { EmbeddingProvider, SearchResult } from '../../src/index.ts';
...
if (!REPO_PATH) {
    console.error('Usage: npx tsx test/benchmarks/embedding-providers.ts <repo-path>');
    process.exit(1);
}

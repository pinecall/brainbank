/**
 * @brainbank/docs — Document Search
 *
...
import type { SearchResult, Reranker, EmbeddingProvider } from 'brainbank';
import { reciprocalRankFusion, normalizeBM25 } from 'brainbank';
...
export class DocumentSearch {
    ...
    private async _rerankResults(query: string, results: SearchResult[]): Promise<SearchResult[]> {
        ...
        const { rerank } = await import('brainbank');
